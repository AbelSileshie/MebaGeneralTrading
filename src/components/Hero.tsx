...
export default function Hero({
  ...
  return (
    <section
      id="hero"
      className="relative overflow-hidden text-white h-[100vh] flex items-center"
      style={{
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 py-24 md:py-32 w-full flex items-center min-h-screen">
        ...
        >
          ...
          <motion.p
            ...
            className="text-sm md:text-base text-gray-300 uppercase tracking-wider mb-6 font-semibold"
          >
          </motion.p>
